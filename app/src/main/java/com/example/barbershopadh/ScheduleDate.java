...
import static  com.example.barbershopadh.R.layout.custom_spinner;
...
public class ScheduleDate extends AppCompatActivity {
    ...
    final String[] SESSION_TYPE =  {"Corte de pelo", "Corte de barba", "Peinado", "Pintado de pelo"};
        ...
        if (spinnerValidations()) {
            ...
            builder.setPositiveButton("Guardar", (dialog, which) -> {
                ...
                try {
                    ...
                    if (resultado != -1) {
                        Intent intent = new Intent(this,com.example.barbershopadh.PrincipalMenu.class );//com.AlexDiazH.BarberShop.PrincipalMenu.class
